            ...
            <div class="col-md-auto col-3">
                <div class="dropdown topbar-head-dropdown topbar-tag-dropdown justify-content-end">
                    <button type="button" class="btn btn-icon btn-topbar rounded-circle text-white-50 fs-13"
                        ...
                        <img id="header-lang-img" src="{{ url('assets/backend/images/flags/us.svg') }}" alt="Header Language"
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a href="javascript:void(0);" class="dropdown-item notify-item language py-2"
                            ...
                            <img src="{{ url('assets/backend/images/flags/us.svg') }}" alt="user-image" class="me-2 rounded-circle"
                                height="18">
                        ...
                        <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="sp"
                            title="Spanish">
                            <img src="{{ url('assets/backend/images/flags/spain.svg') }}" alt="user-image"
                        ...
                        <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="gr"
                            title="German">
                            <img src="{{ url('assets/backend/images/flags/germany.svg') }}" alt="user-image"
                        ...
                        <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="it"
                            title="Italian">
                            <img src="{{ url('assets/backend/images/flags/italy.svg') }}" alt="user-image"
                                class="me-2 rounded-circle" height="18">
                        ...
                        <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="ru"
                            title="Russian">
                            <img src="{{ url('assets/backend/images/flags/russia.svg') }}" alt="user-image"
                                class="me-2 rounded-circle" height="18">
                        ...
                        <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="ch"
                            title="Chinese">
                            <img src="{{ url('assets/backend/images/flags/china.svg') }}" alt="user-image"
                                class="me-2 rounded-circle" height="18">
                        ...
                        <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="fr"
                            title="French">
                            <img src="{{ url('assets/backend/images/flags/french.svg') }}" alt="user-image"
                                class="me-2 rounded-circle" height="18">
                        ...
                        <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="ar"
                            title="Arabic">
                            <img src="{{ url('assets/backend/images/flags/ae.svg') }}" alt="user-image" class="me-2 rounded-circle"
                                height="18">
