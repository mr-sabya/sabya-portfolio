...
<section class="education-experience tmp-section-gapTop">
    <div class="container">
        <h2 class="custom-title mb-32 tmp-scroll-trigger tmp-fade-in animation-order-1">Education <span><img src="{{ url('assets/frontend/images/custom-line/custom-line.png') }}"
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="experiences-wrap-right-content">
                        <img class="tmp-scroll-trigger tmp-zoom-in animation-order-1" src="{{ url('assets/frontend/images/experiences/expert-img-two.jpg') }}" alt="expert-img">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="experiences-wrap-left-content">
                        ...
                        <h2 class="custom-title mb-32 tmp-scroll-trigger tmp-fade-in animation-order-1">Experiences <span><img
                                    src="{{ url('assets/frontend/images/custom-line/custom-line.png') }}" alt="custom-line"></span></h2>
